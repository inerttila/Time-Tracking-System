...
// @version      2025-01-21
// @description  Modify transaction amounts and date/time dynamically for SPAs like Stake.com.
// @author       You
...
(function () {
  ...
  function modifySpecificAmount() {
    ...
    for (const cell of tableCells) {
      ...
      if (
        amountElement &&
        amountElement.textContent.trim() === "5135.00000000"
      ) {
  ...
  function modifySpecificDateTime() {
    ...
    for (const element of dateElements) {
      ...
      if (div && div.textContent.includes("10:06 AM 1/14/2025")) {
        ...
        div.innerHTML = `<span style="color: var(--white); font-weight: 600;">Confirmed</span><span>${"11:24 AM 12/22/2024"}</span>`;
        break;
      }
    }
  }
