  ...
  function modifySpecificDateTime() {
    ...
    for (const element of dateElements) {
      ...
      if (div && div.textContent.includes("10:21 AM 1/20/2025")) {
        ...
        if (div) {
          div.innerHTML = `<span style="color: var(--white); font-weight: 600;">Confirmed</span><span>${"5:32 AM 12/22/2024"}</span>`; // Add color and font-weight to Confirmed text
        }

        console.log("Date and time updated to 5:32 AM 12/22/2024");
