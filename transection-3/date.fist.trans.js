...
(function () {
  ...
  function modifySpecificDateTime() {
    ...
    for (const element of dateElements) {
      ...
      if (div && div.textContent.includes("5:32 PM 12/23/2024")) {
        ...
        if (div) {
          div.innerHTML = `<span style="color: var(--white); font-weight: 600;">Confirmed</span><span>${"11:22 AM 12/22/2024"}</span>`; // Add color and font-weight to Confirmed text
        }

        console.log("Date and time updated to 11:22 AM 12/22/2024");
